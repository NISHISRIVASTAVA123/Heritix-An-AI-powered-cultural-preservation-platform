  ...
  return (
    <footer className="bg-[#efeee9] dark:bg-[#121311] w-full rounded-t-[3rem] mt-20 flex flex-col md:flex-row justify-between items-center px-12 py-16">
      <div className="space-y-4 mb-8 md:mb-0 text-center md:text-left">
        <p className="font-headline font-bold text-on-surface text-xl">FolkLore AI</p>
        <p className="font-body text-sm leading-relaxed tracking-normal text-on-surface/70">© 2024 FolkLore AI. Preserving the Living Ledger.</p>
      </div>
